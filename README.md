...
| **Urvi Joshi**     | Reproducible Quarto presentation development (slide structure, R code chunks regenerating figures/tables, revealjs configuration), authoring of findings, limitations, conclusions and recommendations slides, and version control for the presentation branch.                                                                                                                                                                                               |
